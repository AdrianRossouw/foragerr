...
def test_full_app_lifecycle_starts_runs_and_drains_cleanly(config_dir):
    ...
    with TestClient(app) as client:
        ...
        # last_run keep the recurring tick from ever auto-firing it), the
        # daily store-source sync (FRG-SRC-003, m6-humble-source), and the
        # expired-session prune (FRG-AUTH-004, m8-auth-core).
