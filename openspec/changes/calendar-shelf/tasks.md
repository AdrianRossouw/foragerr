...
- [ ] 1.1 `theme/palettes.ts`: normalized lookup (suffix fold +
...
- [ ] 1.2 Tests: live-shape names ("Marvel Comics", "DC Comics", "BOOM!
...
- [ ] 2.1 CalendarScreen row layout at/above the crossover: ~66×99
...
- [ ] 2.2 Absent enrichment collapses (no placeholders); detail surface
      unchanged; quiet cards below crossover unchanged
- [ ] 2.3 Carry the calendar-legibility invariants: 24px targets,
...
- [ ] 3.1 Vitest: shelf anatomy (chip position independent of title
      length, clamp, creators line, cover size class), palette
      normalization through the UI, adapted legibility tests green
- [ ] 3.2 docs/manual/user/web-ui.md calendar section
- [ ] 3.3 Full frontend (tsc + vitest) + backend suites green; tools
