...
- [ ] 1.1 Migration: download_clients, grab_history, tracked_downloads, blocklist, remote_path_mappings, ddl_queue; DownloadClient protocol + provider rows with schema/test endpoints (generic reuse of the change-4 provider machinery) (FRG-DL-001, FRG-DL-002)
