...
- [ ] 3.1 Manual Creators paragraph + RISK-011 note; registry flips;
      baseline sync; matrix regen (FRG-PROC-005/006/011)
- [ ] 3.2 CHANGELOG v0.5.5 + bump on-branch; suites + e2e green; gate
