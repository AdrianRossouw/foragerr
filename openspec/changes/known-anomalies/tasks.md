...
- [ ] 1.2 Create `docs/security/known-anomalies.md` with the register format
      ...
      (FRG-PROC-016)
- [ ] 1.3 Correct `docs/security/history-scan.md`: replace the blanket
...
- [ ] 1.4 Add RISK-042 to `docs/security/risk-register.md`: third-party use
...
- [ ] 2.2 Reference `.gitleaks.toml` from merge-gate checklist item 7 in
      `docs/process/commit-standard.md` (FRG-PROC-015)

## 3. Tests

- [ ] 3.1 Tagged tests (FRG-PROC-016): register parses, KA IDs unique and
      well-formed, required fields present, KA-001 exists
- [ ] 3.2 Tagged test (FRG-PROC-015): gitleaks with the repo config flags a
