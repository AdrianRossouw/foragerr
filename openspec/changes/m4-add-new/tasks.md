...
- [ ] 2.1 Relevance ordering of lookup + suggest candidates in the API layer:
...
- [ ] 2.2 `SeriesCreate` optional `booktype` (vocabulary value or explicit
...
- [ ] 3.1 Rebuild AddSeries presentation to the design handoff: expandable
...
- [ ] 3.2 Rework `AddSeries.test.tsx`: every FRG-UI-005 scenario keeps a
...
- [ ] 4.1 Rewrite `docs/manual/user/web-ui.md` §Adding a series (cards,
...
- [ ] 4.3 Registry header staleness rider: "Transmission" → qBittorrent
