...
| FRG-UI-039 | Per-row ComicVine search picker | ui | approved | M11 |
...
| FRG-SRC-010 | ComicVine-first honest proposals | sources | approved | M11 |
| FRG-SRC-011 | Bundle identity, group actions, and accept-in-bulk | sources | approved | M11 |
| FRG-SRC-012 | Publisher classification rules | sources | approved | M11 |
