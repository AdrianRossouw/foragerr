...
| FRG-SITE-001 | Generated facts only | site | proposed | 0.9.x |
| FRG-SITE-002 | Information architecture and honest framing | site | proposed | 0.9.x |
| FRG-SITE-003 | Timeline generated from release history | site | proposed | 0.9.x |
| FRG-SITE-004 | Trust center renders existing evidence only | site | proposed | 0.9.x |
| FRG-SITE-005 | Automated Pages deployment from main | site | proposed | 0.9.x |
| FRG-SITE-006 | Positioning and licensing accuracy | site | proposed | 0.9.x |
