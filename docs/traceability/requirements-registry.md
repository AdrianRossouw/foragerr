...
| FRG-SER-020 | Trade containment model (declared, display-only) | ser | proposed | M4 |
...
| FRG-API-022 | Containment resources | api | proposed | M4 |
...
| FRG-UI-025 | Issue bulk selection and actions | ui | proposed | M4 |
| FRG-UI-026 | Collections tab | ui | proposed | M4 |
