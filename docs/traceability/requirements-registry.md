...
| FRG-DEP-017 | Documented deployment security posture | dep | proposed | M10 |
...
| FRG-SEC-006 | HTTP security response headers | sec | proposed | M10 |
| FRG-SEC-007 | Opt-in trusted-proxy handling | sec | proposed | M10 |
| FRG-SEC-008 | Unauthenticated disclosure and error hygiene | sec | proposed | M10 |
