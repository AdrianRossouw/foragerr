...
| @tanstack/react-virtual | `^3.14.8` | npm | Windowed rendering of the Sources review list so thousand-row entitlement queues stay responsive (dynamic row measurement for expandable rows) | FRG-UI-029 (review list virtualized at scale) | MIT | Deferred — see methodology |
